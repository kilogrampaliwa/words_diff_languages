...
#tool for counting how many words are in every line
...
#tool for reformating list of words to collumns
...
#tool for reading data in txt in form of collumns

def collumns(file_adress):

    return words_to_collumns(lines_of_words(file_adress))